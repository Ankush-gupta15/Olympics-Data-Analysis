...
def most_successful(df, sport):
    ...
    top_athletes = (temp_df['Name'].value_counts().reset_index(name='Medals')  .rename(columns={'index': 'Name'}))
...
def most_successful_countrywise(df, country):
    ...
    x = top_athletes.head(10).merge(df, on='Name', how='left')[['Name', 'Medals', 'Sport']]
